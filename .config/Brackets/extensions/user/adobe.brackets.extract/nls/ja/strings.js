...
define(["text!./license.html"], function (licenseText) {
	...
	"EULA_HEADER": "アドビソフトウェア使用許諾契約はお客様がご使用の Extract for Brackets (Preview) の機能のみに適用され、Brackets 全般について規定するものではありません。Extract for Brackets (Preview) の使用に同意しない場合は、Brackets が正常に動作を継続します。Brackets は MIT ライセンスによって提供され、使用許諾契約への同意を必要としません。",
	...
	"HOW_TO_DLG_TITLE": "Extract for Brackets (Preview) を使用中",
	"HOW_TO_DLG_MSG_1": "Extract for Brackets では、PSD からデザインの情報やアセットを抽出し、CSS コードに変換できます。",
	"HOW_TO_DLG_MSG_2": "ウィンドウの下部にある PSD ビューでレイヤーを選択します。",
	"HOW_TO_DLG_MSG_3": "CSS ルール内にカーソルを置いて入力を開始すると (または Ctrl キーを押しながらスペースキーを押すと)、選択したレイヤーの外観に基づいた CSS のプロパティと値のコードヒントが表示されます。",
	"HOW_TO_DLG_TRY_IT_NOW": "今すぐ試す",

	"PANEL_TITLE": "Creative Cloud アセット",
	"OPEN_A_PSD": "PSD を開く\u2026",
	...
	"ERROR_ASSET_LIST_MESSAGE": "フォルダー <span class='dialog-filename'>{0}</span> を表示する際にエラーが発生しました。",
        ...
        // Override ccweb
	"Drag and Drop a PSD here": "アップロードするには<br/>PSD ファイルをここにドラッグ",
	"Upload PSD": "PSDをアップロードする",
	"UPLOADING": "アップロード中",
	"PROCESSING": "処理中"
    };
});
